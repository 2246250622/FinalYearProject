...
<div class="row">
            ...
            <div class="signup-form">
                <form action="<?php echo $_SERVER["PHP_SELF"] ?>" method="post" class="mt-5 border p-4 bg-light shadow">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-12">
                        <label>Professional Qualifications Certificates<span class="text-danger">*</span></label>

                          <ul>
                          <li>Certificate in Caregiver;</li>
                          <li>Certificate in Integrated Caregiver Training;</li>
                          <li>Certificate in Elderly Care and Nursing Skills;</li>
    </ul>
    ...
    <div class="form-check">
      ...
      By clicking "Submit," you agree to our <a href="../Layout/termsofuse.php">Terms of Use</a> and <a href="../Layout/termsofuse.php">Privacy Policy</a>.
      </div>
    </div>
  </div>
  <br>  <br>  <br>
          ...
          move_uploaded_file($pdf_tem_loc,$pdf_store);
                ...
                <?php
                  ...
                  if ($total > 0){
                    ...
                    $sql = "INSERT INTO user VALUES(NULL,'$fname','$lname','$gender','$dob','$countrycode$phonenumber','$hkid','$email','$password','$pdf', '$description','caretaker','Unapproved',NULL)";

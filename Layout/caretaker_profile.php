...
?>
       ...
       if (isset($_POST["update_user"])) {
        ...
        $sql = "UPDATE user SET FName = '$FName', LName = '$LName', Phone = '$Phone' , Password = '$Password', Description = '$Description' WHERE ID = '$_POST[ID]';";
    $result = mysqli_query($conn, $sql);
...
<div class="mb-3 row">
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <textarea  class="form-control" name="Description" id="Description" placeholder="<?php echo $row['Description']; ?>"></textarea>
    </div>
  </div>
